...
public struct ChatTheme {
    ...
    public init(
        ...
        quickReplyBackgroundColor: Color      = Color(sdkHex: 0xF9FAFC),
        ...
        agentMessageFont: Font                = .system(size: SdkConstants.titleFontSize),
        ...
        bubbleCornerRadius: CGFloat           = SdkConstants.messageBorderRadius,

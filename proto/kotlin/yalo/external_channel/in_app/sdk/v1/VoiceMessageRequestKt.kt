...
@kotlin.jvm.JvmName("-initializevoiceMessageRequest")
public inline fun voiceMessageRequest(block: yalo.external_channel.in_app.sdk.v1.VoiceMessageRequestKt.Dsl.() -> kotlin.Unit): yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VoiceMessageRequest =
  yalo.external_channel.in_app.sdk.v1.VoiceMessageRequestKt.Dsl._create(yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VoiceMessageRequest.newBuilder()).apply { block() }._build()
/**
 * ```
 * VoiceMessageRequest is sent by either party to deliver a voice note.
 * ```
 *
 * Protobuf type `yalo.external_channel.in_app.sdk.v1.VoiceMessageRequest`
 */
public object VoiceMessageRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VoiceMessageRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VoiceMessageRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VoiceMessageRequest = _builder.build()
    ...
    public val VoiceMessageRequestKt.Dsl.contentOrNull: yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VoiceMessage?
    ...
    public val VoiceMessageRequestKt.Dsl.timestampOrNull: com.google.protobuf.Timestamp?
...
public inline fun yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VoiceMessageRequest.copy(block: `yalo.external_channel.in_app.sdk.v1`.VoiceMessageRequestKt.Dsl.() -> kotlin.Unit): yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VoiceMessageRequest =
  `yalo.external_channel.in_app.sdk.v1`.VoiceMessageRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VoiceMessageRequestOrBuilder.contentOrNull: yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VoiceMessage?
  get() = if (hasContent()) getContent() else null

public val yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VoiceMessageRequestOrBuilder.timestampOrNull: com.google.protobuf.Timestamp?

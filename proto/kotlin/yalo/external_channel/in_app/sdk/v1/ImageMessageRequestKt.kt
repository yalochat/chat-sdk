...
public inline fun imageMessageRequest(block: yalo.external_channel.in_app.sdk.v1.ImageMessageRequestKt.Dsl.() -> kotlin.Unit): yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.ImageMessageRequest =
  yalo.external_channel.in_app.sdk.v1.ImageMessageRequestKt.Dsl._create(yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.ImageMessageRequest.newBuilder()).apply { block() }._build()
/**
 * ```
 * ImageMessageRequest is sent by either party to deliver an image.
 * ```
 *
 * Protobuf type `yalo.external_channel.in_app.sdk.v1.ImageMessageRequest`
 */
public object ImageMessageRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.ImageMessageRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.ImageMessageRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.ImageMessageRequest = _builder.build()

    /**
     * `.yalo.external_channel.in_app.sdk.v1.ImageMessage content = 1;`
     */
    public var content: yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.ImageMessage
    ...
    public val ImageMessageRequestKt.Dsl.contentOrNull: yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.ImageMessage?
...
public val yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.ImageMessageRequestOrBuilder.contentOrNull: yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.ImageMessage?
  get() = if (hasContent()) getContent() else null

public val yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.ImageMessageRequestOrBuilder.timestampOrNull: com.google.protobuf.Timestamp?

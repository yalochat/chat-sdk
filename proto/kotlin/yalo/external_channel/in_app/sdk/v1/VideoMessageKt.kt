...
public inline fun videoMessage(block: yalo.external_channel.in_app.sdk.v1.VideoMessageKt.Dsl.() -> kotlin.Unit): yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VideoMessage =
  yalo.external_channel.in_app.sdk.v1.VideoMessageKt.Dsl._create(yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VideoMessage.newBuilder()).apply { block() }._build()
/**
 * ```
 * VideoMessage holds the payload of a video conversation turn.
 * ```
 *
 * Protobuf type `yalo.external_channel.in_app.sdk.v1.VideoMessage`
 */
public object VideoMessageKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VideoMessage.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VideoMessage.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VideoMessage = _builder.build()
    ...
    /**
     * `.yalo.external_channel.in_app.sdk.v1.MessageRole role = 6;`
     */
...
public inline fun yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VideoMessage.copy(block: `yalo.external_channel.in_app.sdk.v1`.VideoMessageKt.Dsl.() -> kotlin.Unit): yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VideoMessage =
  `yalo.external_channel.in_app.sdk.v1`.VideoMessageKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.VideoMessageOrBuilder.timestampOrNull: com.google.protobuf.Timestamp?

...
public inline fun textMessage(block: yalo.external_channel.in_app.sdk.v1.TextMessageKt.Dsl.() -> kotlin.Unit): yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.TextMessage =
  yalo.external_channel.in_app.sdk.v1.TextMessageKt.Dsl._create(yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.TextMessage.newBuilder()).apply { block() }._build()
/**
 * ```
 * TextMessage holds the payload of a plain-text conversation turn.
 * ```
 *
 * Protobuf type `yalo.external_channel.in_app.sdk.v1.TextMessage`
 */
public object TextMessageKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.TextMessage.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.TextMessage.Builder): Dsl = Dsl(builder)
    }
...
public inline fun yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.TextMessage.copy(block: `yalo.external_channel.in_app.sdk.v1`.TextMessageKt.Dsl.() -> kotlin.Unit): yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.TextMessage =
  `yalo.external_channel.in_app.sdk.v1`.TextMessageKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val yalo.external_channel.in_app.sdk.v1.SdkMessageOuterClass.TextMessageOrBuilder.timestampOrNull: com.google.protobuf.Timestamp?

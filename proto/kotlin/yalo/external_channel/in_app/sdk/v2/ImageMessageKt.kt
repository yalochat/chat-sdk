...
public inline fun imageMessage(block: yalo.external_channel.in_app.sdk.v2.ImageMessageKt.Dsl.() -> kotlin.Unit): yalo.external_channel.in_app.sdk.v2.SdkMessageOuterClass.ImageMessage =
  yalo.external_channel.in_app.sdk.v2.ImageMessageKt.Dsl._create(yalo.external_channel.in_app.sdk.v2.SdkMessageOuterClass.ImageMessage.newBuilder()).apply { block() }._build()
/**
 * ```
 * ImageMessage holds the payload of an image conversation turn.
 * ```
 *
 * Protobuf type `yalo.external_channel.in_app.sdk.v2.ImageMessage`
 */
public object ImageMessageKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: yalo.external_channel.in_app.sdk.v2.SdkMessageOuterClass.ImageMessage.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: yalo.external_channel.in_app.sdk.v2.SdkMessageOuterClass.ImageMessage.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): yalo.external_channel.in_app.sdk.v2.SdkMessageOuterClass.ImageMessage = _builder.build()
...
public inline fun yalo.external_channel.in_app.sdk.v2.SdkMessageOuterClass.ImageMessage.copy(block: `yalo.external_channel.in_app.sdk.v2`.ImageMessageKt.Dsl.() -> kotlin.Unit): yalo.external_channel.in_app.sdk.v2.SdkMessageOuterClass.ImageMessage =
  `yalo.external_channel.in_app.sdk.v2`.ImageMessageKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val yalo.external_channel.in_app.sdk.v2.SdkMessageOuterClass.ImageMessageOrBuilder.timestampOrNull: com.google.protobuf.Timestamp?

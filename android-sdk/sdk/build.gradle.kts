...
android {
    ...
    sourceSets {
        ...
        // regenerated by `make proto_kotlin`). Mirrors how flutter-sdk and web-sdk consume
        // proto/dart/ and proto/typescript/ via symlinks — source is always readable in the repo.
        getByName("main") {
            java.srcDir("../../proto/kotlin")
        }
    }
